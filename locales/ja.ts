...
export default {
    ...
    login: {
        head: {
            title: 'DeepLog＜ディープログ＞｜ログイン画面',
            description:
                'Webサイトを一元管理するWebアプリケーション、DeepLog＜ディープログ＞のログイン画面',
        },
        header: {
            description: 'Webサイトの一元管理',
        },
        form: {
            email: 'Eメール',
            password: 'パスワード',
    ...
    signup: {
        head: {
            title: 'DeepLog＜ディープログ＞｜新規登録画面',
            description:
                'Webサイトを一元管理するWebアプリケーション、DeepLog＜ディープログ＞の新規登録画面',
        },
        header: {
            description: 'Webサイトの一元管理',
        },
    ...
    dialog: {
        ...
        addCategories: {
            title: 'カテゴリー',
            contentText: 'カテゴリーを複数選択することができます',
        },
        createCategory: {
            title: '新規カテゴリー',
    ...
    account: {
        ...
        logout: 'ログアウト',
        setting: '設定',
        settingDeepLog: 'DeepLogアプリケーションの設定',
        lang: '言語',
    },
    user: {
        name: '名前',
