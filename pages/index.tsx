        ...
        const init = async () => {
            ...
            if (!isAfterLogin) {
                ...
                const publicCategoryList =
                    await categoryUiController.findPublic();
    ...
    return (
        <>
            <NextSeo
                ...
                canonical={'https://deep-log.net'}
                openGraph={{
                    url: 'https://deep-log.net',
                    title: t.index.head.title,
                    description: t.index.head.description,
                    type: 'website',
                    locale: locale,
                    images: [
                        {
                            url: 'https://deep-log.s3.ap-northeast-1.amazonaws.com/DeepRecommend+(1).png',
                            width: 800,
                            height: 600,
                            alt: 'DeepRecommend',
                            type: 'image/png',
